...
def obtener_usuarios_masvoz():
    driver_masvoz = obtener_web_masvoz('Cuenta')    
    sleep(1)
    tabla = esperar_elemento(driver=driver_masvoz,buscar_por=By.ID,texto_buscado='gridview-1018-table')
    sleep(1)
